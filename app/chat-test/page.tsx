...
import { Bot, User, Send, Settings, RotateCcw } from "lucide-react"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6">
            <Card className="hologram-card border-0 bg-background/30 backdrop-blur-sm">
              ...
              {showPromptEditor && (
                <CardContent className="pt-0" id="prompt-editor">
                  <div className="space-y-4">
                    ...
                    <div
                      id="prompt-hint"
                      className="text-xs text-muted-foreground bg-background/30 p-3 rounded-lg border border-border/30"
                    >
          ...
          {/* Features */}
          <section className="grid md:grid-cols-3 gap-6 mt-12" aria-label="Özellikler">
            <article className="hologram-card p-6 rounded-2xl text-center space-y-4">
              <div
                className="w-12 h-12 bg-gradient-to-br from-neon-blue to-neon-cyan rounded-2xl flex items-center justify-center mx-auto"
                aria-hidden="true"
              >
                <Bot className="w-6 h-6 text-white" />
              </div>
              <h2 className="text-lg font-semibold text-foreground">Akıllı Yanıtlar</h2>
            ...
            <article className="hologram-card p-6 rounded-2xl text-center space-y-4">
              <div
                className="w-12 h-12 bg-gradient-to-br from-neon-purple to-tech-orange rounded-2xl flex items-center justify-center mx-auto"
                aria-hidden="true"
              >
                <Send className="w-6 h-6 text-white" />
              </div>
              <h2 className="text-lg font-semibold text-foreground">Hızlı İletişim</h2>
              <p className="text-sm text-muted-foreground">Anında yanıt alın ve kesintisiz sohbet deneyimi yaşayın.</p>
            </article>

            <article className="hologram-card p-6 rounded-2xl text-center space-y-4">
              <div
                className="w-12 h-12 bg-gradient-to-br from-neon-cyan to-neon-purple rounded-2xl flex items-center justify-center mx-auto"
                aria-hidden="true"
              >
                <User className="w-6 h-6 text-white" />
              </div>
              <h2 className="text-lg font-semibold text-foreground">Kişisel Asistan</h2>

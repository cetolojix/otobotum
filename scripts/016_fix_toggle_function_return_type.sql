...
-- Create UPSERT function with correct return types matching the table schema
...
-- Fixed return type for customer_phone to match table schema (character varying instead of text)
RETURNS TABLE (
  id UUID,
  ai_enabled BOOLEAN,

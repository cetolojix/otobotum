-- Expert-fixed version of toggle_conversation_ai function
-- Fixes ambiguous column reference by using table aliases everywhere
...
BEGIN
  ...
  IF v_conversation_id IS NULL THEN
    ...
    RETURNING id, customer_phone, customer_name 
    INTO v_conversation_id, v_debug_phone, v_debug_name;
  ...
  INTO v_debug_phone, v_debug_name
  FROM conversations c
  WHERE c.id = v_conversation_id;
